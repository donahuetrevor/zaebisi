	...
	<div class="box-content">
		<?php echo form_open(); ?>
			...
			<div class="column-left">
				<p>
					<?php echo form_input(array('value' => $movie_genre_obj->name, 'id' => 'name', 'name' => 'name', 'placeholder' => ucfirst(_('genre name'))));?>
				</p>
				<p class="warning">
			...
			<div class="action_bar">
				<?php echo form_submit(array('value' => _('edit'), 'class' => 'button blue'));?>
